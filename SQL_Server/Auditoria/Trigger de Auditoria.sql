...
AS 
  DECLARE @data xml 
  SET @data = eventdata()   
  INSERT INTO DBADMIN.dbo.TBAuditoriaDDL 		 
...
--alerta os eventos de ROLE SERVER MEMBER o time de DBADMINS
...
FROM DBADMIN.dbo.TBAuditoriaDDL 
...
@recipients = 'patrociniomaia@gmail.com', -- grupo de DBADMINs
@subject = @assunto, 
@body = @corpo,
@body_format = 'text'		  
